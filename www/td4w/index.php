...
echo '
 ...
 |_| \_\/_/   \_\____/ |_/_/   \_\_| |_|\___/|_| \_\_| \_(_)____\___/|_|  |_|         
			...
			<meta name="keywords" content="rasta, horn, rastahorn, rastahorn.com, reagge, womp, hype, party, sound, effects, burlington, vermont, jamaica, wamp, noise" />
			...
			<!-- Rasta Styles -->
			<link href="../css/td4w.css" rel="stylesheet" type="text/css">
			<!-- Rasta Scripts -->
			';
			if($browser == 'iphone'){
				echo '<script type="text/javascript">
					function playNew() {
						...
						tag.setAttribute("src","../media/td4w.mp3")
				...
				echo '<script type="text/javascript" src="../js/td4w.js"</script>';
					//function playNew() {	
		...
		<body>
			<div class="container">
				<audio id="rasta" src="../media/td4w.mp3" preload="auto">Sorry, your browser does not support HTML5</audio>
				<img src="../images/td4w.png" alt="TURN DOWN FOR WHAT" onClick="playNew()" />
